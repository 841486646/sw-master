...
<body style="display: block;">
    ...
    <main class="wrap"><section class="fill-form"><ul><li><input type="text" placeholder="请输入您的姓名" name="name" id="name"></li><li><input type="text" placeholder="请输入能联系到您的手机号（必填）" name="phone" id="phone"></li><li><textarea class="fill-form-textarea" name="content" placeholder="请详细描述故障" id="content" cols="30" rows="3"></textarea></li>
