...
public class HttpRequest {
	 ...
	 public static final String autograph="。【北京易族恒信科技】";
	 
	 public static final String appkey="520b72f0d2f33bc2";
	 
	 public static final String short_message="http://api.jisuapi.com/sms/send";
    ...
    public static JSONObject sendGet(String url, String param) {
        ...
        try {
            ...
            List<String> Location1= map.get("Location");
            result= Location1.get(0);
            // 遍历所有的响应头字段
    ...
    public static void main(String[] args) {
    	String as="mobile=13357705236&content=2016-06-03 10:24:39手机13357705236用户提交了订单，描述故障为：2323。【北京易族恒信科技】&appkey=520b72f0d2f33bc2";
        JSONObject a=HttpRequest.sendPost("http://api.jisuapi.com/sms/send", as);
